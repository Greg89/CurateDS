...
- A separate API plus web frontend keeps the product modular while V2 focuses on the browser experience.
...
Do not build mobile now. Keep the current foundation focused by:
...
Future clients can be reconsidered after V2 has a strong web product and a clearer reason to add another surface.
